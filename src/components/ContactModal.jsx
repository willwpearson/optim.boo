    ...
    return (
        ...
        >
            <div className="bg-black p-4 rounded-xl shadow-xl shadow-violetLight/75 flex flex-col items-center space-y-8">
                ...
                <button className="text-center text-sunflowerDark hover:text-sunflowerLight text-2xl shadow shadow-sunflowerDark hover:shadow-sunflowerLight p-2 rounded-lg" onClick={() => returnHome()}>
                    <h1>Return Home</h1>
                </button>
            </div>
        </Transition>
